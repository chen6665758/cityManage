...
* 时间：2019/10/25 15:53
*/
public class EventImpatientActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void setContentView() {
        setContentView(R.layout.activity_event_impatient);
    }
    ...
    private void initData()
    {
        ...
        OkGo.<String>post(Constants.EVENTIMPATIENT_URL)
                .tag(this)//
                            ...
                            if(resultCode.equals("2000"))
                            {
                                ...
                                if(array.length() > 0)
                                {
                                    for(int i = 0;i<array.length();i++) {
                                        ...
                                        model.setIsImpatient(child.getString("urgeStatus"));
                                        list_data.add(model);
                                    }
