...
* 时间：2019/10/29 11:08
*/
public class EventCirculateDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void setContentView() {
        setContentView(R.layout.activity_event_circulate_detail);
    }
...
//                                EventFlowListModel
                    ...
                    public void onError(Response<String> response) {
                        ...
                        progress_Dialog.dismiss();
                        Log.e("EventCirculate", "行数: 257  error:" + response.body());
                    }
                });
    }
