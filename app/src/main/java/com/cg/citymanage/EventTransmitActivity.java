...
* 时间：2019/10/25 8:50
*/
public class EventTransmitActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initData()
    {
        ...
        OkGo.<String>post(Constants.EVENTTRANSMIT_URL)
                .tag(this)//
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        {
                            Log.e("EventTransmit", "行数: 200  ex:" + ex.getMessage());
                    ...
                    public void onError(Response<String> response) {
                        ...
                        progress_Dialog.dismiss();
                        Log.e("EventTransmit", "行数: 211  error:" + response.body());
                    }
                });
    }
    ...
    public void tempData()
    {
        for(int i=0;i<10;i++)
        {
            ...
            model.setEventName("第" + i + "事件传阅");
            model.setEventTime("2019-10-" + (i+1));
            model.setEventLink("[当前环节：立案" + i + "]");
            model.setEventInfo("203032019102100"+i+":事件传阅的事件");
            list_data.add(model);
        }
