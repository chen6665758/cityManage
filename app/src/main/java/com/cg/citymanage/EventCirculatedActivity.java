...
* 时间：2019/10/29 10:56
*/
public class EventCirculatedActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void setContentView() {
        setContentView(R.layout.activity_event_circulated);
    }
    ...
    private void initData()
    {
        ...
        OkGo.<String>post(Constants.EVENTCIRCULATED_URL)
                .tag(this)//
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        {
                            Log.e("EventCirculated", "行数: 201  ex:" + ex.getMessage());
                    ...
                    public void onError(Response<String> response) {
                        ...
                        progress_Dialog.dismiss();
                        Log.e("EventCirculated", "行数: 212  error:" + response.body());
                    }
                });
    }
